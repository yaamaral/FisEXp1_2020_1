...
%\input{QuedaLivre}
%\input{Volume}
%\input{PlanoInclinado}
%\input{Colisoes}
%\input{Rolamento}

\part[Guia de Conceitos Básicos para Análise de Dados]{Guia de Conceitos Básicos para Análise de Dados}
\setcounter{chapter}{0}
\input MedidasIncertezas.tex
\input MedidasDiretasIndiretas.tex
\input AlgarismosSignificativos.tex
\input HistogramaGraficos.tex
\input MinimosQuadrados.tex
\input VelocidadeInstantanea.tex
\input DistribuicaoGaussiana.tex
%
%\input{Capitulo1}
...
\appendix 
\input{UsoCaderno}
\input{ComoEscreverRelatorio}
\input{UsoPaquimetro}
%\input{TrilhoAr}
%\input{UsoSistemaVideo}
